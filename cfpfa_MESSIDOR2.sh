...
DATA_PATH_MESSIDOR2="/SAN/ioo/AlzeyeTempProjects/boxuanli/MESSIDOR2/"



for n_round in 1 2 3 4
do
TASK_DIR="./finetune_CFPFA_epo${myEpoch}_MESSIDOR2_${n_round}/"
# running command
################################################
...
TASK_DIR="./external_CFPFA_epo${myEpoch}_MESSIDOR2_${n_round}/"
RESUME_DIR="./finetune_CFPFA_epo${myEpoch}_MESSIDOR2_${n_round}/checkpoint-best.pth"
