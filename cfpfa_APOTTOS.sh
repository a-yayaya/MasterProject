...
do
TASK_DIR="./finetune_CFPFA_epo${myEpoch}_APOTTOS_${n_round}/"
# running command
################################################
...
TASK_DIR="./external_CFPFA_epo${myEpoch}_APOTTOS_${n_round}/"
RESUME_DIR="./finetune_CFPFA_epo${myEpoch}_APOTTOS_${n_round}/checkpoint-best.pth"
python -m torch.distributed.launch --nproc_per_node=1 --master_port=48792 external_validation.py \
    --eval \
    --batch_size 24 \
    --world_size 2 \
    --model vit_large_patch16 \
